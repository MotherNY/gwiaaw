...
function cleaner(){
  ...
  walkAndUnlink( path.join(__dirname, 'public', 'js'), new RegExp(/guesswho-/) )
}
...
function smoosher(){
  ...
  smoosh.make({
    ...
    "JAVASCRIPT": {
      "DIST_DIR": "./public/js",
      "guesswho": [ "./public/js/guesswho.js" ]
    },
    "CSS": {
      "DIST_DIR": "./public/css",
  ...
  .done(function(){
    ...
    var newProdFile = 'guesswho-'+ version +'.min'
    
    var write = js.replace('guesswho', newProdFile)
